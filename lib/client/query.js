...
Query.prototype._handleResponse = function(err, data, extra) {
  ...
  wait += Array.isArray(data) ? data.length : Object.keys(data).length;
  this.results = this._ingestSnapshots(data, finish);
  this.extra = extra;
  this._listenToDocs(this.results);

  finish();
};

Query.prototype._listenToDocs = function(docs) {
...
Query.prototype._ingestSnapshots = function(snapshots, finish) {
  ...
  if (Array.isArray(snapshots)) {
    ...
    console.log('Query Ingest Snapshot non-array', snapshots);
